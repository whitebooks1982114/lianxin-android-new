...
public class Alarm_Content extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTV = (TextView)findViewById(R.id.alarm_detail_title_tv);
        contentTV = (TextView)findViewById(R.id.alarm_detail_content_tv);
        deadlineTV = (TextView)findViewById(R.id.alarm_detail_deadline_tv);
        backbtn = (Button)findViewById(R.id.alarm_detail_back_btn);
